...
Your experiment is now ready to run. You can access the controlpanel by going to controlpanel.php or to _beginControl.php

.. important:: For security reasons, delete ENABLESETUP.php from your server after setting up your server so that no one else can set up (or destroy) the database.
