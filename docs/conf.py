...
latex_documents = [
  ('index', 'ReadtheDocsTemplate.tex', u'LIONESS documentation',
...
man_pages = [
    ('index', 'readthedocstemplate', u'LIONESS documentation',
     [u'Read the Docs'], 1)
]
...
texinfo_documents = [
  ('index', 'ReadtheDocsTemplate', u'LIONESS documentation',
   u'Read the Docs', 'LIONESS', 'One line description of project.',
   'Miscellaneous'),
]
